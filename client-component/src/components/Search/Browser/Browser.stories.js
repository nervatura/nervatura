...
Default.args = {
  ...
  keyMap: Queries({ msg: (key)=> key } ).customer(),
  viewDef: Queries({ msg: (key)=> key } ).customer().CustomerView,
  paginationPage: 2
}
...
Columns.args = {
  ...
  viewDef: Queries({ msg: (key)=> key } ).customer().CustomerContactView,
}
...
Filters.args = {
  ...
  viewDef: {
    ...Queries({ msg: (key)=> key } ).customer().CustomerFieldsView,
    readonly: true
  }
}
...
HavingFilter.args = {
  ...
  keyMap: Queries({ msg: (key)=> key } ).transmovement(),
  viewDef: Queries({ msg: (key)=> key } ).transmovement().InventoryView,
}
...
FormActions.args = {
  ...
  keyMap: Queries({ msg: (key)=> key } ).rate(),
  viewDef: Queries({ msg: (key)=> key } ).rate().RateView,
}