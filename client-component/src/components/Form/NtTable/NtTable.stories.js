...
import { PAGINATION_TYPE } from './NtTable.js'
...
Default.args = {
  ...
  fields: {
    ...
    editor: { columnDef: { 
      ...
      Header: "",
      headerStyle: {},
      Cell: ({ row }) => html`<nt-button 
        type="primary" ?full="${true}" ?disabled="${row.disabled}" ?small="${true}" >Hello</nt-button>`,
      cellStyle: {}
    }},
    id: { columnDef: {
      id: "id",
