          ...
          edit: { columnDef: { 
            ...
            Cell: ({ row }) => {
              const ecol = (actions.edit !== null) ? html`<form-icon id=${`edit_${row.id}`}
                  ...
                  @click=${ ()=>this._onEditEvent(EDIT_EVENT.FORM_ACTION , { params: actions.edit, row, ref: this })}
                ></form-icon>` : undefined
              const dcol = (actions.delete !== null) ? html`<form-icon id=${`delete_${row.id}`}
                  ...
                  @click=${ ()=>this._onEditEvent(EDIT_EVENT.FORM_ACTION , { params: actions.delete, row })}
                ></form-icon>` : undefined
