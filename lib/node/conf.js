...
module.exports = {
  ...
  lang: "en",
  enforces_ssl: !process.env.DISABLED_SSL || true,
  pg_ssl: process.env.PGSSLMODE || false, //require or false
  mysql_ssl: (typeof(process.env.MYSQL_SSL) !== "undefined") || false, //true or false
  mssql_encrypt: (typeof(process.env.MSSQL_ENCRYPT) !== "undefined") || false, //true or false
  ...
  def_settings: {
    nas_auth: "local", //local, azure, google
    python2_path: "python",
