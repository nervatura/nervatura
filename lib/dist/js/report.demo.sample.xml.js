  ...
  return {
    Template: getXml(function() {
      ...
      <details>
        ...
        <row>
          <columns>
            <cell name="label" width="50%" font-style="bold" value="labels.left_text" border="LT" border-color="218" background-color="245" />
            <cell name="label" font-style="bold" value="labels.left_text" border="LTR" border-color="218" background-color="245" />
          </columns>
        </row>
        <row>
          <columns>
            <cell name="short_text" width="50%" value="head.short_text" border="L" border-color="218" />
            <cell name="short_text" value="head.short_text" border="LR" border-color="218" />
          </columns>
        </row>
        <row>
          <columns>
            <cell name="short_text" width="50%" value="head.short_text" border="LB" border-color="218" />
            <cell name="short_text" value="head.short_text" border="LBR" border-color="218" />
          </columns>
        </row>
        <row>
          <columns>
            <cell name="label" width="40" font-style="bold" value="labels.left_text" border="LB" border-color="218" />
            <cell name="label" align="center" width="30" font-style="bold" value="labels.center_text" border="LB" border-color="218" />
            <cell name="label" align="right" width="40" font-style="bold" value="labels.right_text" border="LB" border-color="218" />
            <cell name="label" font-style="bold" value="labels.left_text" border="LBR" border-color="218" />
          </columns>
        </row>
        <row>
          <columns>
            <cell name="short_text" width="40" value="head.short_text" border="LB" border-color="218" />
            <cell name="date" align="center" width="30" value="head.date" border="LB" border-color="218" />
            <cell name="amount" align="right" width="40" value="head.number" border="LB" border-color="218" />
            <cell name="short_text" value="head.short_text" border="LBR" border-color="218" />
          </columns>
        </row>
        <row>
          <columns>
            <cell name="label" font-style="bold" value="labels.left_text" border="LB" border-color="218" />
            <cell name="short_text" width="50" value="head.short_text" border="LB" border-color="218" />
            <cell name="label" font-style="bold" value="labels.left_text" border="LB" border-color="218" />
            <cell name="short_text" value="head.short_text" border="LBR" border-color="218" />
          </columns>
        ...
        <row>
          <columns>
            <cell name="long_text" multiline="true" value="head.long_text" border="LBR" border-color="218" />
          </columns>
        </row>
        <vgap height="2" />
        <row hgap="2">
          <columns>
            <cell name="label" value="labels.left_text" font-style="bold" border="1" border-color="245" background-color="245" />
            <cell name="short_text" value="head.short_text" border="1" border-color="218" />
            <cell name="label" value="labels.left_text" font-style="bold" border="1" border-color="245" background-color="245" />
            <cell name="short_text" value="head.short_text" border="1" border-color="218" />
          </columns>
        </row>
        ...
        <row hgap="2">
          <columns>
            <cell name="label" value="labels.long_text" font-style="bold" border="1" border-color="245" background-color="245" />
            <cell name="long_text" multiline="true" value="head.long_text" border="1" border-color="218" />
          </columns>
        </row>
        <vgap height="2"/>
        <row hgap="2">
        ...
        <row hgap="3">
          <columns>
            ...
            <barcode code-type="i2of5" value="1234567890" visible-value="1"/>
            <cell name="label" value="Barcode (Code 39)" font-style="bold" font-size="10" 
              border="1" border-color="245" background-color="245"/>
            <barcode code-type="code39" value="1234567890ABCDEF" visible-value="1"/>
          </columns>
        </row>
        <vgap height="3"/>
        <row>
          <columns>
            <cell name="label" value="Datagrid Sample" align="center" font-style="bold" border="1" border-color="245" 
                  background-color="245"/>
          </columns>
        </row>
        <vgap height="2" />
        <datagrid name="items" databind="items" border="1" border-color="218" header-background="245" footer-background="245">
          <columns>
