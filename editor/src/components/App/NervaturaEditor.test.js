...
import './nervatura-editor.js';

describe('Nervatura Report Editor', () => {
  it('renders without crashing', async () => {
    const client = await fixture(html`<nervatura-editor id="client" ></nervatura-editor>`);
  ...
  it('form-spinner', async () => {
    ...
    const client = await fixture(html`<nervatura-editor id="client" .state=${state} ></nervatura-editor>`);
    expect(client.id).to.equal("client")
  })
