...
import { SIDE_VISIBILITY, SIDE_EVENT, BUTTON_TYPE, TEXT_ALIGN, APP_THEME } from '../../../config/enums.js'
  ...
  formItems(){
    ...
    panels.push(
      this.itemMenu({
        id: "cmd_theme",
        selected: true, 
        eventValue: [SIDE_EVENT.THEME,{}],
        label: this.msg("", { id: "menu_theme" }), 
        iconKey: (this.theme === APP_THEME.DARK) ? "Sun" : "Moon", 
        full: false, 
      })
    )
    ...
    panels.push(
      this.itemMenu({
        id: "cmd_help", 
        eventValue: [SIDE_EVENT.HELP, { value: "editor" }],
    ...
    panels.push(
      this.itemMenu({
        id: "cmd_logout", 
        eventValue: [SIDE_EVENT.LOGOUT, {}],
        label: this.msg("", { id: "menu_logout" }), 
        iconKey: "Exit"
      })
    )
