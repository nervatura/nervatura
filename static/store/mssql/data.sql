...
VALUES('USR0000000000N1', 'admin', 'GROUP_ADMIN', 0, JSON_OBJECT(
  'tags': JSON_ARRAY()
), JSON_OBJECT());
...
VALUES('CUS0000000000N1', 'CUSTOMER_OWN', 'COMPANY NAME', 
  ...
  JSON_OBJECT(
    'tax_number':'12345678-1-12', 'account':'', 'tax_free':0, 
    'terms':0, 'credit_limit':0, 'discount':0, 'notes':'', 'inactive':0, 'tags': JSON_ARRAY()
  ), JSON_OBJECT()
);
