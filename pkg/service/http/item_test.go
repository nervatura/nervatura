...
func TestItemPost(t *testing.T) {
	...
	}{
		{
			...
			ds: &api.DataStore{
				...
				ConvertFromReader: func(r io.Reader, v any) error {
					return cu.ConvertFromByte([]byte(`{"code": "123456", "trans_code": "123456", "product_code": "123456", "tax_code": "123456"}`), v)
				},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			ItemPost(tt.args.w, tt.args.r.WithContext(ctx))
		})
	}
}
...
func TestItemPut(t *testing.T) {
	...
	}{
		{
			...
			ds: &api.DataStore{
				...
				ReadAll: func(r io.Reader) ([]byte, error) {
					return []byte(`{"code": "123456", "trans_code": "123456", "product_code": "123456", "tax_code": "123456"}`), nil
				},
				ConvertFromReader: func(r io.Reader, v any) error {
					return cu.ConvertFromByte([]byte(`{"code": "123456", "trans_code": "123456", "product_code": "123456", "tax_code": "123456"}`), v)
				},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			ctx := context.WithValue(context.Background(), md.DataStoreCtxKey, tt.ds)
			ItemPut(tt.args.w, tt.args.r.WithContext(ctx))
		})
	}
}
...
func TestItemDelete(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				w: httptest.NewRecorder(),
				r: httptest.NewRequest("DELETE", "/item/1", nil),
			},
			ds: &api.DataStore{
				Db: &md.TestDriver{
					Config: cu.IM{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			ctx := context.WithValue(context.Background(), md.DataStoreCtxKey, tt.ds)
			ItemDelete(tt.args.w, tt.args.r.WithContext(ctx))
		})
	}
}
...
func TestItemQuery(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				w: httptest.NewRecorder(),
				r: httptest.NewRequest("GET", "/item?limit=10&offset=0&trans_code=123456&product_code=123456&tag=123456", nil),
			},
			ds: &api.DataStore{
				Db: &md.TestDriver{
					Config: cu.IM{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			ctx := context.WithValue(context.Background(), md.DataStoreCtxKey, tt.ds)
			ItemQuery(tt.args.w, tt.args.r.WithContext(ctx))
		})
	}
}
...
func TestItemGet(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			ctx := context.WithValue(context.Background(), md.DataStoreCtxKey, tt.ds)
			ItemGet(tt.args.w, tt.args.r.WithContext(ctx))
		})
	}
}
