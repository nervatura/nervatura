...
func init() {
	toolDataMap["nervatura_customer_create"] = McpTool{
		Tool: mcp.Tool{
	...
	toolDataMap["nervatura_customer_query"] = McpTool{
		Tool: mcp.Tool{
	...
	toolDataMap["nervatura_customer_update"] = McpTool{
		Tool: mcp.Tool{
	...
	toolDataMap["nervatura_customer_delete"] = McpTool{
