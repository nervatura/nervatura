import{j as e,D as t,A as a,a as s,i as r,b as i}from"./module-1JqPnLJw.js";import{e as o,i as n,o as l,a as c}from"./module-BCutSLl1.js";import{l as d}from"./module-NpGsdRHB.js";const{I:p}=e,g=e=>e,h=(e,t)=>void 0!==e?._$litType$,u=e=>void 0===e.strings,m=()=>document.createComment(""),E=(e,t,a)=>{const s=e._$AA.parentNode,r=e._$AB;if(void 0===a){const t=s.insertBefore(m(),r),i=s.insertBefore(m(),r);a=new p(t,i,e,e.options)}else{const t=a._$AB.nextSibling,i=a._$AM,o=i!==e;if(o){let t;a._$AQ?.(e),a._$AM=e,void 0!==a._$AP&&(t=e._$AU)!==i._$AU&&a._$AP(t)}if(t!==r||o){let e=a._$AA;for(;e!==t;){const t=g(e).nextSibling;g(s).insertBefore(e,r),e=t}}}return a},T={},_=(e,t=T)=>e._$AH=t,A=e=>e._$AH,b=e=>(e=>null!=e?._$litType$?.h)(e)?e._$litType$.h:e.strings,f=o(class extends n{constructor(e){super(e),this.et=new WeakMap}render(e){return[e]}update(e,[s]){const r=h(this.it)?b(this.it):null,i=h(s)?b(s):null;if(null!==r&&(null===i||r!==i)){const s=A(e).pop();let i=this.et.get(r);if(void 0===i){const e=document.createDocumentFragment();i=t(a,e),i.setConnected(!1),this.et.set(r,i)}_(i,[s]),E(i,0,s)}if(null!==i){if(null===r||r!==i){const t=this.et.get(i);if(void 0!==t){const a=A(t).pop();(e=>{e._$AR()})(e),E(e,0,a),_(e,[a])}}this.it=s}else this.it=void 0;return this.render(s)}});var v=s`
html, :host {
...
`;customElements.define("form-spinner",class extends r{render(){return i`
    ...
    </div>`}static get styles(){return[K]}});const V=s`
:host {
	font-family: var(--font-family);
	font-size: var(--font-size);
	color: var(--text-1);
...
`;customElements.define("form-toast",class extends r{constructor(){super(),this.id=Math.random().toString(36).slice(2),this.name=void 0,this.type=I.INFO,this.hidden=!0,this.timeout=4,this.style={},this._iconMap={info:"InfoCircle",error:"ExclamationTriangle",success:"CheckSquare"}}static get properties(){return{id:{type:String},name:{type:String,reflect:!0},type:{type:String},hidden:{type:Boolean},timeout:{type:Number},style:{type:Object}}}connectedCallback(){super.connectedCallback(),this.setData&&this.setData("current",{toast:this},!1)}disconnectedCallback(){this.setData&&this.setData("current",{toast:null},!1),super.disconnectedCallback()}show({type:e,value:t,timeout:a}){this.hidden&&(this.value=t||this.value,this.type=e||this.type,this.timeout=void 0!==a?a:this.timeout,this.hidden=!1,this.timeout>0&&(this.timeoutVar=setTimeout(()=>{this&&!this.hidden&&(this.hidden=!0)},1e3*this.timeout)))}close(){this.hidden||(clearTimeout(this.timeoutVar),this.hidden=!0)}render(){return this.hidden?a:i`<div 
      ...
      ?showValue="${o||!1}"
      .onEvent=${d}
    ></modal-inputbox>`}_protector(){const{data:e}=this.state,{current:t,session:s}=this.state.data;return e[C.LOGIN].data?i`
      <div theme="${t.theme}" class="main">
        ${f(t.module===C.TEMPLATE?i`<client-template
          id="template" .data=${e[C.TEMPLATE]} 
          side="${t.side}"
    ...
    `}});export{C as A,S as B,D,R as E,y as I,O as L,$ as M,k as P,F as S,I as T,x as a,w as b,P as c,M as d,N as e,L as f,u as r};
