...
VALUES('CONFIG_MAP', json_object(
  ...
  'tags',  json_array(), 
  'filter',  json_array('FILTER_PRODUCT','FILTER_EMPLOYEE')
));
INSERT INTO config(config_type, data) 
VALUES('CONFIG_MAP', json_object(
...
json_object(
  'tax_number', '87654321-1-12', 'account', '', 'tax_free', json('false'), 
  'terms', 8, 'credit_limit', 1000000, 'discount', 2, 'inactive', json('false'), 'notes', '', 
  'tags', json_array()
), 
json_object(
...
json_object(
  'tax_number', '12121212-1-12', 'account', '', 'tax_free', json('false'), 
  'terms', 1, 'credit_limit', 0, 'discount', 6, 'inactive', json('false'), 'notes', '', 
  'tags', json_array()
), 
json_object(
...
json_object(
  'tax_number', '23232323-1-12', 'account', '', 'tax_free', json('true'), 
  'terms', 4, 'credit_limit', 0, 'discount', 6, 'inactive', json('false'), 'notes', '', 
  'tags', json_array()
), 
json_object(
  'demo_color', 'BROWN'
...
json_object(
  'start_date', '2020-12-01', 'end_date', '', 'inactive', json('false'), 'notes', '',
...
json_object(
  'unit', 'piece', 'inactive', json('false'), 'notes', '',
...
json_object(
  'unit', 'hour', 'inactive', json('false'), 'notes', '',
  'barcode_type', 'BARCODE_CODE_39', 'barcode', '', 'barcode_qty', 0,
  'tags', json_array('SOUVENIR')
), 
json_object(
...
json_array(),
json_object(
  'unit', 'piece', 'inactive', json('false'), 
...
json_array(),
json_object(
  'unit', 'liter', 'inactive', json('false'), 
  'notes', 'Raw material, component', 
  'barcode_type', 'BARCODE_CODE_39', 'barcode', '', 'barcode_qty', 0,
  'tags', json_array('WEBITEM', 'COMPONENT')
), 
...
json_object(
  ...
  'barcode_type', 'BARCODE_CODE_39', 'barcode', '', 'barcode_qty', 0,
  'tags', json_array('COMPONENT','SOUVENIR')
), 
json_object(
...
json_object(
  ...
  'inactive', json('false'), 'notes', '', 'tags', json_array()
), 
json_object(
...
json_object(
  'serial_number', 'ABC-123', 'inactive', json('false'), 'notes', '', 'tags', json_array('CAR')
), 
json_object(
...
json_array(),
json_object(
  'serial_number', 'DEF-456', 'inactive', json('false'), 'notes', '', 'tags', json_array('CAR')
), 
json_object(
...
json_array(),
json_object(
  'serial_number', 'IMEI-023456789', 'inactive', json('false'), 'notes', '', 'tags', json_array()
), 
json_object());
...
json_object(
  ...
  'tax_free', json('false'), 'paid', json('false'), 'rate', 0, 'closed', json('false'), 
...
INSERT INTO trans(
  code, trans_type, direction, trans_date, trans_code, customer_code, employee_code, project_code, 
  place_code, currency_code, auth_code, trans_meta, trans_map) 
VALUES('DEL0000000000N16', 'TRANS_DELIVERY', 'DIRECTION_TRANSFER', '2024-11-08', NULL, NULL, NULL, NULL, 'PLA0000000000N4', NULL, 'USR0000000000N1',
json_object(
  'due_time', '', 'ref_number', '', 'paid_type', 'PAID_TRANSFER', 
  'tax_free', json('false'), 'paid', json('false'), 'rate', 0, 'closed', json('false'), 
  'status', 'STATUS_NORMAL', 'trans_state', 'STATE_OK', 
...
INSERT INTO trans(
  code, trans_type, direction, trans_date, trans_code, customer_code, employee_code, project_code, 
  place_code, currency_code, auth_code, trans_meta, trans_map) 
VALUES('INE0000000000N17', 'TRANS_INVENTORY', 'DIRECTION_TRANSFER', '2024-12-01', NULL, NULL, NULL, NULL, 'PLA0000000000N1', NULL, 'USR0000000000N1',
json_object(
  'due_time', '', 'ref_number', '', 'paid_type', 'PAID_TRANSFER', 
  'tax_free', json('false'), 'paid', json('false'), 'rate', 0, 'closed', json('false'), 
  'status', 'STATUS_NORMAL', 'trans_state', 'STATE_OK', 
...
json_object(
  ...
  'description', 'Wheel', 'deposit', json('false'), 'own_stock', 0, 'action_price', json('false'),
  'tags', json_array()
), 
json_object());
INSERT INTO item(
...
json_object(
  ...
  'description', 'Door', 'deposit', json('false'), 'own_stock', 0, 'action_price', json('false'),
  'tags', json_array()
), 
json_object());
INSERT INTO item(
...
json_object(
  ...
  'description', 'Paint', 'deposit', json('false'), 'own_stock', 0, 'action_price', json('false'),
  'tags', json_array()
), 
json_object());
INSERT INTO item(
...
json_object(
  ...
  'description', 'Pallet', 'deposit', json('false'), 'own_stock', 0, 'action_price', json('false'),
  'tags', json_array()
), 
json_object());
INSERT INTO item(
...
json_object(
  ...
  'description', 'Big product', 'deposit', json('false'), 'own_stock', 0, 'action_price', json('false'),
  'tags', json_array()
), 
json_object());
INSERT INTO item(
...
json_object(
  ...
  'description', 'Nice product', 'deposit', json('false'), 'own_stock', 0, 'action_price', json('false'),
  'tags', json_array()
), 
json_object());
INSERT INTO item(
...
json_object(
  ...
  'description', 'Basket', 'deposit', json('false'), 'own_stock', 0, 'action_price', json('false'),
  'tags', json_array()
), 
json_object());
INSERT INTO item(
...
json_object(
  ...
  'description', 'Wine', 'deposit', json('false'), 'own_stock', 0, 'action_price', json('false'),
  'tags', json_array()
), 
json_object());
INSERT INTO item(
...
json_object(
  ...
  'description', 'Chocolate', 'deposit', json('false'), 'own_stock', 0, 'action_price', json('false'),
  'tags', json_array()
), 
json_object());
...
json_object(
  ...
  'description', 'Souvenir - virtual product', 'deposit', json('false'), 'own_stock', 0, 'action_price', json('false'),
  'tags', json_array()
), 
json_object());
INSERT INTO item(
...
json_object(
  ...
  'description', 'Very good work!', 'deposit', json('false'), 'own_stock', 0, 'action_price', json('false'),
  'tags', json_array()
), 
json_object());
INSERT INTO item(
...
json_object(
  ...
  'description', 'Good work', 'deposit', json('false'), 'own_stock', 0, 'action_price', json('false'),
  'tags', json_array()
), 
json_object());
INSERT INTO item(
