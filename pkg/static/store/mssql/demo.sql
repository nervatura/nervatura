...
JSON_OBJECT(
  'tax_number':'87654321-1-12', 'account':'', 'tax_free':0, 
  'terms':8, 'credit_limit':1000000, 'discount':2, 'inactive':0, 'notes':'', 
  'tags': JSON_ARRAY()
), 
JSON_OBJECT(
...
JSON_OBJECT(
  'tax_number':'12121212-1-12', 'account':'', 'tax_free':0, 
  'terms':1, 'credit_limit':0, 'discount':6, 'inactive':0, 'notes':'', 
  'tags': JSON_ARRAY()
), 
JSON_OBJECT(
...
JSON_OBJECT(
  'tax_number':'23232323-1-12', 'account':'', 'tax_free':1, 
  'terms':4, 'credit_limit':0, 'discount':6, 'inactive':0, 'notes':'', 
  'tags': JSON_ARRAY()
), 
JSON_OBJECT(
  'demo_color':'BROWN'
...
JSON_OBJECT(
  'start_date':'2020-12-01', 'end_date':'', 'inactive':0, 'notes':'',
...
JSON_ARRAY(),
JSON_OBJECT(
  'unit':'piece', 'inactive':0, 'notes':'Manufacturing products', 
  'barcode_type':'BARCODE_CODE_39', 'barcode':'', 'barcode_qty':0,
  'tags': JSON_ARRAY('WEBITEM')
), 
JSON_OBJECT());
...
JSON_ARRAY(),
JSON_OBJECT(
  'unit':'piece', 'inactive':0, 'notes':'Raw material, component',
  'barcode_type':'BARCODE_CODE_39', 'barcode':'', 'barcode_qty':0,
...
JSON_ARRAY(),
JSON_OBJECT(
  'unit':'liter', 'inactive':0, 'notes':'Raw material, component',
  'barcode_type':'BARCODE_CODE_39', 'barcode':'', 'barcode_qty':0,
  'tags': JSON_ARRAY('WEBITEM', 'COMPONENT')
), 
JSON_OBJECT());
...
JSON_ARRAY(),
JSON_OBJECT(
  'unit':'piece', 'inactive':0, 'notes':'Raw material, component (not share sample)', 
  'barcode_type':'BARCODE_CODE_39', 'barcode':'', 'barcode_qty':0,
  'tags': JSON_ARRAY('WEBITEM', 'COMPONENT')
), 
JSON_OBJECT());
...
JSON_ARRAY(),
JSON_OBJECT(
  'unit':'piece', 'inactive':0, 'notes':'Souvenir component', 
  'barcode_type':'BARCODE_CODE_39', 'barcode':'', 'barcode_qty':0,
...
JSON_ARRAY(),
JSON_OBJECT(
  'unit':'piece', 'inactive':0, 'notes':'A technical package, which might include several real products or services', 
  'barcode_type':'BARCODE_CODE_39', 'barcode':'', 'barcode_qty':0,
  'tags': JSON_ARRAY('WEBITEM')
), 
JSON_OBJECT());
...
JSON_ARRAY(),
JSON_OBJECT(
  'unit':'piece', 'inactive':0, 'notes':'for tool movement...', 
  'barcode_type':'BARCODE_CODE_39', 'barcode':'', 'barcode_qty':0,
  'tags': JSON_ARRAY()
), 
JSON_OBJECT());
...
JSON_OBJECT(
  ...
  'inactive':0, 'notes':'', 'tags': JSON_ARRAY(), 'project_map': JSON_OBJECT()
), 
JSON_OBJECT(
...
JSON_OBJECT(
  'serial_number':'ABC-123', 'inactive':0, 'notes':'', 'tags': JSON_ARRAY('CAR')
), 
JSON_OBJECT(
...
JSON_ARRAY(),
JSON_OBJECT(
  'serial_number':'DEF-456', 'inactive':0, 'notes':'', 'tags': JSON_ARRAY('CAR')
), 
JSON_OBJECT(
...
JSON_ARRAY(),
JSON_OBJECT(
  'serial_number':'IMEI-023456789', 'inactive':0, 'notes':'', 'tags': JSON_ARRAY()
), 
JSON_OBJECT());
...
VALUES('PLA0000000000N4', 'PLACE_WAREHOUSE', 'Raw material', 
  ...
  JSON_OBJECT(
    'notes':'', 'inactive':0, 'tags': JSON_ARRAY()
  ), JSON_OBJECT()
);
...
JSON_OBJECT(
  ...
  'tax_free':0, 'paid':0, 'rate':0, 'closed':0, 
...
JSON_OBJECT(
  ...
  'description': 'Wheel', 'deposit': 0, 'own_stock': 0, 'action_price': 0,
  'tags': JSON_ARRAY()
), 
JSON_OBJECT());
INSERT INTO item(
...
JSON_OBJECT(
  ...
  'description': 'Door', 'deposit': 0, 'own_stock': 0, 'action_price': 0,
  'tags': JSON_ARRAY()
), 
JSON_OBJECT());
INSERT INTO item(
...
JSON_OBJECT(
  ...
  'description': 'Paint', 'deposit': 0, 'own_stock': 0, 'action_price': 0,
  'tags': JSON_ARRAY()
), 
JSON_OBJECT());
INSERT INTO item(
...
JSON_OBJECT(
  ...
  'description': 'Pallet', 'deposit': 0, 'own_stock': 0, 'action_price': 0,
  'tags': JSON_ARRAY()
), 
JSON_OBJECT());
INSERT INTO item(
...
JSON_OBJECT(
  ...
  'description': 'Big product', 'deposit': 0, 'own_stock': 0, 'action_price': 0,
  'tags': JSON_ARRAY()
), 
JSON_OBJECT());
INSERT INTO item(
...
JSON_OBJECT(
  ...
  'description': 'Nice product', 'deposit': 0, 'own_stock': 0, 'action_price': 0,
  'tags': JSON_ARRAY()
), 
JSON_OBJECT());
INSERT INTO item(
...
JSON_OBJECT(
  ...
  'description': 'Basket', 'deposit': 0, 'own_stock': 0, 'action_price': 0,
  'tags': JSON_ARRAY()
), 
JSON_OBJECT());
INSERT INTO item(
...
JSON_OBJECT(
  ...
  'description': 'Wine', 'deposit': 0, 'own_stock': 0, 'action_price': 0,
  'tags': JSON_ARRAY()
), 
JSON_OBJECT());
INSERT INTO item(
...
JSON_OBJECT(
  ...
  'description': 'Chocolate', 'deposit': 0, 'own_stock': 0, 'action_price': 0,
  'tags': JSON_ARRAY()
), 
JSON_OBJECT());
...
JSON_OBJECT(
  ...
  'description': 'Souvenir - virtual product', 'deposit': 0, 'own_stock': 0, 'action_price': 0,
  'tags': JSON_ARRAY()
), 
JSON_OBJECT());
INSERT INTO item(
...
JSON_OBJECT(
  ...
  'description': 'Very good work!', 'deposit': 0, 'own_stock': 0, 'action_price': 0,
  'tags': JSON_ARRAY()
), 
JSON_OBJECT());
INSERT INTO item(
...
JSON_OBJECT(
  'unit': 'piece', 'qty': 15, 'fx_price': 8, 'net_amount': 120, 'discount': 0, 'vat_amount': 2,
  'description': 'Basket', 'deposit': 0, 'own_stock': 0, 'action_price': 0,
  'tags': JSON_ARRAY()
), 
JSON_OBJECT());
...
JSON_OBJECT(
  ...
  'description': 'Good work', 'deposit': 0, 'own_stock': 0, 'action_price': 0,
  'tags': JSON_ARRAY()
), 
JSON_OBJECT());
INSERT INTO item(
...
JSON_OBJECT(
  'qty': 0, 'notes': '', 'shared': 0, 'tags': JSON_ARRAY()
), 
JSON_OBJECT());
INSERT INTO movement(
  code, movement_type, shipping_time, trans_code, product_code, tool_code, place_code, item_code, movement_code, movement_meta, movement_map) 
...
JSON_OBJECT(
  'qty': 0, 'notes': 'mobile phone', 'shared': 0, 'tags': JSON_ARRAY()
), 
JSON_OBJECT());
...
JSON_OBJECT(
  'qty': 30, 'notes': 'demo', 'shared': 0, 'tags': JSON_ARRAY()
), 
JSON_OBJECT());
INSERT INTO movement(
  code, movement_type, shipping_time, trans_code, product_code, tool_code, place_code, item_code, movement_code, movement_meta, movement_map) 
...
JSON_OBJECT(
  'qty': 50, 'notes': 'demo', 'shared': 0, 'tags': JSON_ARRAY()
), 
JSON_OBJECT());
INSERT INTO movement(
  code, movement_type, shipping_time, trans_code, product_code, tool_code, place_code, item_code, movement_code, movement_meta, movement_map) 
...
JSON_OBJECT(
  'qty': 15, 'notes': 'demo', 'shared': 0, 'tags': JSON_ARRAY()
), 
JSON_OBJECT());
INSERT INTO movement(
  code, movement_type, shipping_time, trans_code, product_code, tool_code, place_code, item_code, movement_code, movement_meta, movement_map) 
...
JSON_OBJECT(
  'qty': 10, 'notes': 'demo', 'shared': 0, 'tags': JSON_ARRAY()
), 
JSON_OBJECT());
INSERT INTO movement(
  code, movement_type, shipping_time, trans_code, product_code, tool_code, place_code, item_code, movement_code, movement_meta, movement_map) 
...
JSON_OBJECT(
  'qty': 20, 'notes': 'demo', 'shared': 0, 'tags': JSON_ARRAY()
), 
JSON_OBJECT());
...
JSON_OBJECT(
  'qty': -2, 'notes': 'demo', 'shared': 0, 'tags': JSON_ARRAY()
), 
JSON_OBJECT());
INSERT INTO movement(
  code, movement_type, shipping_time, trans_code, product_code, tool_code, place_code, item_code, movement_code, movement_meta, movement_map) 
...
JSON_OBJECT(
  'qty': -4, 'notes': 'demo', 'shared': 0, 'tags': JSON_ARRAY()
), 
JSON_OBJECT());
INSERT INTO movement(
  code, movement_type, shipping_time, trans_code, product_code, tool_code, place_code, item_code, movement_code, movement_meta, movement_map) 
...
JSON_OBJECT(
  'qty': -3, 'notes': 'demo', 'shared': 0, 'tags': JSON_ARRAY()
), 
JSON_OBJECT());
...
JSON_OBJECT(
  'qty': -5, 'notes': 'demo', 'shared': 0, 'tags': JSON_ARRAY()
), 
JSON_OBJECT());
...
JSON_OBJECT(
  'qty': 1, 'notes': 'demo', 'shared': 1, 'tags': JSON_ARRAY()
), 
JSON_OBJECT());
...
JSON_OBJECT(
  'qty': 28, 'notes': 'demo', 'shared': 0, 'tags': JSON_ARRAY()
), 
JSON_OBJECT());
INSERT INTO movement(
  code, movement_type, shipping_time, trans_code, product_code, tool_code, place_code, item_code, movement_code, movement_meta, movement_map) 
...
JSON_OBJECT(
  'qty': 2, 'notes': 'demo', 'shared': 1, 'tags': JSON_ARRAY()
), 
JSON_OBJECT());
INSERT INTO movement(
  code, movement_type, shipping_time, trans_code, product_code, tool_code, place_code, item_code, movement_code, movement_meta, movement_map) 
...
JSON_OBJECT(
  'qty': -8, 'notes': 'demo', 'shared': 0, 'tags': JSON_ARRAY()
), 
JSON_OBJECT());
INSERT INTO movement(
  code, movement_type, shipping_time, trans_code, product_code, tool_code, place_code, item_code, movement_code, movement_meta, movement_map) 
...
JSON_OBJECT(
  'qty': -12, 'notes': 'demo', 'shared': 0, 'tags': JSON_ARRAY()
), 
JSON_OBJECT());
INSERT INTO movement(
  code, movement_type, shipping_time, trans_code, product_code, tool_code, place_code, item_code, movement_code, movement_meta, movement_map) 
...
JSON_OBJECT(
  'qty': -1, 'notes': 'demo', 'shared': 0, 'tags': JSON_ARRAY()
), 
JSON_OBJECT());
