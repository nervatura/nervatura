...
func TestClientService_projectData(t *testing.T) {
	type fields struct {
		Config       cu.IM
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			_, err := cls.projectData(tt.args.ds, tt.args.user, tt.args.params)
			if (err != nil) != tt.wantErr {
				t.Errorf("ClientService.projectData() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
		})
	}
...
func TestClientService_projectUpdate(t *testing.T) {
	type fields struct {
		Config       cu.IM
		AuthConfigs  map[string]*oauth2.Config
		AppLog       *slog.Logger
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			_, err := cls.projectUpdate(tt.args.ds, tt.args.data)
			if (err != nil) != tt.wantErr {
				t.Errorf("ClientService.projectUpdate() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
		})
	}
...
func TestClientService_projectResponse(t *testing.T) {
	type fields struct {
		Config       cu.IM
		AuthConfigs  map[string]*oauth2.Config
		AppLog       *slog.Logger
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			_, err := cls.projectResponse(tt.args.evt)
			if (err != nil) != tt.wantErr {
				t.Errorf("ClientService.projectResponse() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
		})
	}
