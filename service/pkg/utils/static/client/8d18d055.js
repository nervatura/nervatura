import{j as e,D as t,A as a,i as r,s,x as i}from"./78651bea.js";import{e as o,i as n,l,o as c}from"./9cb62222.js";import{l as d}from"./95ec07a4.js";const{I:p}=e,h=(e,t)=>void 0===t?void 0!==(null==e?void 0:e._$litType$):(null==e?void 0:e._$litType$)===t,u=e=>void 0===e.strings,g=()=>document.createComment(""),m=(e,t,a)=>{var r;const s=e._$AA.parentNode,i=void 0===t?e._$AB:t._$AA;if(void 0===a){const t=s.insertBefore(g(),i),r=s.insertBefore(g(),i);a=new p(t,r,e,e.options)}else{const t=a._$AB.nextSibling,o=a._$AM,n=o!==e;if(n){let t;null===(r=a._$AQ)||void 0===r||r.call(a,e),a._$AM=e,void 0!==a._$AP&&(t=e._$AU)!==o._$AU&&a._$AP(t)}if(t!==i||n){let e=a._$AA;for(;e!==t;){const t=e.nextSibling;s.insertBefore(e,i),e=t}}}return a},_={},E=(e,t=_)=>e._$AH=t,T=e=>e._$AH,f=e=>(e=>{var t;return null!=(null===(t=null==e?void 0:e._$litType$)||void 0===t?void 0:t.h)})(e)?e._$litType$.h:e.strings,A=o(class extends n{constructor(e){super(e),this.tt=new WeakMap}render(e){return[e]}update(e,[r]){const s=h(this.et)?f(this.et):null,i=h(r)?f(r):null;if(null!==s&&(null===i||s!==i)){const r=T(e).pop();let i=this.tt.get(s);if(void 0===i){const e=document.createDocumentFragment();i=t(a,e),i.setConnected(!1),this.tt.set(s,i)}E(i,[r]),m(i,void 0,r)}if(null!==i){if(null===s||s!==i){const t=this.tt.get(i);if(void 0!==t){const a=T(t).pop();(e=>{e._$AR()})(e),m(e,void 0,a),E(e,[a])}}this.et=r}else this.et=void 0;return this.render(r)}});var b=r`
html, :host {
...
`;customElements.define("form-toast",class extends s{constructor(){super(),this.id=Math.random().toString(36).slice(2),this.name=void 0,this.type=O.INFO,this.hidden=!0,this.timeout=4,this.style={},this._iconMap={info:"InfoCircle",error:"ExclamationTriangle",success:"CheckSquare"}}static get properties(){return{id:{type:String},name:{type:String,reflect:!0},type:{type:String},hidden:{type:Boolean},timeout:{type:Number},style:{type:Object}}}connectedCallback(){super.connectedCallback(),this.setData&&this.setData("current",{toast:this},!1)}disconnectedCallback(){this.setData&&this.setData("current",{toast:null},!1),super.disconnectedCallback()}show({type:e,value:t,timeout:a}){this.hidden&&(this.value=t||this.value,this.type=e||this.type,this.timeout=void 0!==a?a:this.timeout,this.hidden=!1,this.timeout>0&&(this.timeoutVar=setTimeout((()=>{this&&!this.hidden&&(this.hidden=!0)}),1e3*this.timeout)))}close(){this.hidden||(clearTimeout(this.timeoutVar),this.hidden=!0)}render(){return this.hidden?a:i`<div 
    ...
    `}});export{v as A,y as B,w as D,U as E,D as I,x as L,N as M,F as P,M as S,O as T,G as a,S as b,L as c,k as d,I as e,P as f,$ as g,A as h,R as i,q as j,C as k,H as l,j as m,B as n,u as o};
