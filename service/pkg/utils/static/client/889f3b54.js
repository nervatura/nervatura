import{Z as e,B as t,A as a,i as r,s,x as i}from"./60a3e750.js";import{e as o,i as n,l,o as c}from"./7963f2ae.js";import{l as d}from"./95ec07a4.js";const{I:p}=e,h=(e,t)=>void 0===t?void 0!==(null==e?void 0:e._$litType$):(null==e?void 0:e._$litType$)===t,g=e=>void 0===e.strings,u=()=>document.createComment(""),m=(e,t,a)=>{var r;const s=e._$AA.parentNode,i=void 0===t?e._$AB:t._$AA;if(void 0===a){const t=s.insertBefore(u(),i),r=s.insertBefore(u(),i);a=new p(t,r,e,e.options)}else{const t=a._$AB.nextSibling,o=a._$AM,n=o!==e;if(n){let t;null===(r=a._$AQ)||void 0===r||r.call(a,e),a._$AM=e,void 0!==a._$AP&&(t=e._$AU)!==o._$AU&&a._$AP(t)}if(t!==i||n){let e=a._$AA;for(;e!==t;){const t=e.nextSibling;s.insertBefore(e,i),e=t}}}return a},_={},E=(e,t=_)=>e._$AH=t,T=e=>e._$AH,f=o(class extends n{constructor(e){super(e),this.tt=new WeakMap}render(e){return[e]}update(e,[r]){if(h(this.et)&&(!h(r)||this.et.strings!==r.strings)){const r=T(e).pop();let s=this.tt.get(this.et.strings);if(void 0===s){const e=document.createDocumentFragment();s=t(a,e),s.setConnected(!1),this.tt.set(this.et.strings,s)}E(s,[r]),m(s,void 0,r)}if(h(r)){if(!h(this.et)||this.et.strings!==r.strings){const t=this.tt.get(r.strings);if(void 0!==t){const a=T(t).pop();(e=>{e._$AR()})(e),m(e,void 0,a),E(e,[a])}}this.et=r}else this.et=void 0;return this.render(r)}});var A=r`
html, :host {
...
`;customElements.define("form-toast",class extends s{constructor(){super(),this.id=Math.random().toString(36).slice(2),this.name=void 0,this.type=w.INFO,this.hidden=!0,this.timeout=4,this.style={},this._iconMap={info:"InfoCircle",error:"ExclamationTriangle",success:"CheckSquare"}}static get properties(){return{id:{type:String},name:{type:String,reflect:!0},type:{type:String},hidden:{type:Boolean},timeout:{type:Number},style:{type:Object}}}connectedCallback(){super.connectedCallback(),this.setData&&this.setData("current",{toast:this},!1)}disconnectedCallback(){this.setData&&this.setData("current",{toast:null},!1),super.disconnectedCallback()}show({type:e,value:t,timeout:a}){this.hidden&&(this.value=t||this.value,this.type=e||this.type,this.timeout=void 0!==a?a:this.timeout,this.hidden=!1,this.timeout>0&&(this.timeoutVar=setTimeout((()=>{this&&!this.hidden&&(this.hidden=!0)}),1e3*this.timeout)))}close(){this.hidden||(clearTimeout(this.timeoutVar),this.hidden=!0)}render(){return this.hidden?a:i`<div 
    ...
    `}});export{b as A,S as B,D,q as E,y as I,M as L,x as M,N as P,R as S,w as T,U as a,v as b,$ as c,O as d,I as e,L as f,f as g,F as h,C as i,P as j,k,G as l,B as m,H as n,g as o};
