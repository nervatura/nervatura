import{i as e,s as t,x as i,a,A as l,T as n}from"./3cff389a.js";import{o,i as s,t as r,e as d,l as c}from"./7854850a.js";import"./4318ffa4.js";import{d as p,k as m,B as v,S as u,e as h,E as b,j as g,P as f,a as $,M as y,I as x}from"./64e23944.js";import"./58a1a1d2.js";import"./5217a594.js";import{e as _,n as E}from"./77ff5e2f.js";import"./2e1816aa.js";import"./3c9c664f.js";import"./95ec07a4.js";const w=e`
:host {
...
`;customElements.define("sidebar-edit",class extends t{constructor(){super(),this.msg=e=>e,this.side=p.AUTO,this.view=m.EDIT,this.module={current:{},form_dirty:!1,dirty:!1,panel:{},dataset:{},group_key:""},this.newFilter=[],this.auditFilter={},this.forms={}}static get properties(){return{side:{type:String,reflect:!0},view:{type:String,reflect:!0},newFilter:{type:Array},auditFilter:{type:Object},module:{type:Object},forms:{type:Object}}}static get styles(){return[w]}_onSideEvent(e,t){this.onEvent&&this.onEvent.onSideEvent&&this.onEvent.onSideEvent({key:e,data:t}),this.dispatchEvent(new CustomEvent("side_event",{bubbles:!0,composed:!0,detail:{key:e,data:t}}))}itemMenu({id:e,selected:t,eventValue:a,label:l,iconKey:n,full:o,disabled:s,align:r,color:d}){const c=void 0!==t&&t,p=void 0===o||o,m=void 0!==s&&s,u=void 0===r?h.LEFT:r,b={"border-radius":"0","border-color":"rgba(var(--accent-1c), 0.2)"};return d&&(b.color=d,b.fill=d),i`<form-button 
        id="${e}" label="${l}"
        ?full="${p}" ?disabled="${m}" ?selected="${c}"
        align=${u}
        .style="${b}"
        icon="${n}" type="${v.PRIMARY}"
        @click=${()=>this._onSideEvent(...a)} 
      >${l}</form-button>`}editItems(e){const{current:t,dirty:a,form_dirty:l,dataset:n}=this.module,s=void 0===e?{}:e,r=[];if((!0===s.back||t.form)&&(r.push(this.itemMenu({id:"cmd_back",selected:!0,eventValue:[u.BACK,{}],label:this.msg("",{id:"label_back"}),iconKey:"Reply",full:!1})),r.push(i`<hr id="back_sep" class="separator" />`)),!0===s.arrow&&(r.push(this.itemMenu({id:"cmd_arrow_left",eventValue:[u.PREV_NUMBER,{}],label:this.msg("",{id:"label_previous"}),iconKey:"ArrowLeft"})),r.push(this.itemMenu({id:"cmd_arrow_right",eventValue:[u.NEXT_NUMBER,{}],label:this.msg("",{id:"label_next"}),iconKey:"ArrowRight",align:h.RIGHT})),r.push(i`<hr id="arrow_sep" class="separator" />`)),s.state&&"normal"!==s.state){const e="deleted"===s.state?"rgb(var(--functional-red))":"cancellation"===s.state?"rgb(var(--functional-yellow))":"rgba(var(--accent-1c), 0.85)",t=["closed","readonly"].includes(s.state)?"Lock":"ExclamationTriangle";r.push(i`<div key="cmd_state" class="state-label" >
      ...
      ${e.form||"transitem_shipping"===e.form_type?a:i`<div class="row full container">
          <div class="cell half">
            ${this.itemMenu({id:"state_new",selected:!(this.view===m.EDIT&&e.item),eventValue:[u.CHANGE,{fieldname:"side_view",value:"new"}],label:this.msg("",{id:"label_new"}),iconKey:"Plus",align:h.CENTER})}
          </div>
          <div class="cell half">
            ${this.itemMenu({id:"state_edit",selected:!(this.view!==m.EDIT||!e.item),eventValue:[u.CHANGE,{fieldname:"side_view",value:"edit"}],label:this.msg("",{id:"label_edit"}),iconKey:"Edit",disabled:!e.item,align:h.CENTER})}
          </div>
        </div>`}
      ${this.view===m.EDIT&&e.form||this.view===m.EDIT&&e.item?this.editItems(t):this.newItems()}
     </div>`}});const k=e`
:host {
  font-family: var(--font-family);
  font-size: var(--font-size);
...
`;customElements.define("edit-main",class extends t{constructor(){super(),this.msg=e=>e,this.id=Math.random().toString(36).slice(2),this.audit="",this.current={},this.template={},this.dataset={},this.onEvent={}}static get properties(){return{id:{type:String},audit:{type:String},current:{type:Object},template:{type:Object},dataset:{type:Object},onEvent:{type:Object}}}static get styles(){return[k]}_onEditEvent(e,t){this.onEvent.onEditEvent&&this.onEvent.onEditEvent({key:e,data:t}),this.dispatchEvent(new CustomEvent("edit_event",{bubbles:!0,composed:!0,detail:{key:e,data:t}}))}render(){const{audit:e,current:t,dataset:l,template:n}=this;return i`<div id="${this.id}" class="panel" >
      ${n.rows.map(((a,o)=>i`<form-row
        ...
        .onEdit=${e=>this._onEditEvent(g.EDIT_ITEM,e)}
        .onEvent=${(...e)=>this._onEditEvent(...e)}
        .onSelector=${(...e)=>this._onEditEvent(g.SELECTOR,[...e])}
        .msg=${this.msg}
      ></form-row>`))}
        ...
        ${"readonly"!==e?i`<div class="cell mobile">
          <div class="cell padding-small" >
            <form-select id="sel_deffield"
              ...
              .onChange=${e=>this._onEditEvent(g.CHANGE,{fieldname:"deffield",value:e.value})}
          ...
          ${t.deffield&&""!==t.deffield?i`<div class="cell" >
            <form-button id="btn_new" 
              ...
              @click=${()=>this._onEditEvent(g.CHECK_EDITOR,[{fieldname:t.deffield},b.NEW_FIELDVALUE])} 
...
`;customElements.define("edit-item",class extends t{constructor(){super(),this.msg=e=>e,this.id=Math.random().toString(36).slice(2),this.audit="",this.current={},this.dataset={},this.onEvent={}}static get properties(){return{id:{type:String},audit:{type:String},current:{type:Object},dataset:{type:Object},onEvent:{type:Object}}}static get styles(){return[S]}_onEditEvent(e,t){this.onEvent.onEditEvent&&this.onEvent.onEditEvent({key:e,data:t}),this.dispatchEvent(new CustomEvent("edit_event",{bubbles:!0,composed:!0,detail:{key:e,data:t}}))}render(){const{audit:e,current:t,dataset:a}=this;return i`<div class="row full">
    ...
    <div id="${this.id}" class="panel" >
      ${t.form_template.rows.map(((l,n)=>i`<form-row
        ...
        .msg=${this.msg}
      ></form-row>`))}
    </div>`}});class T extends s{constructor(e){if(super(e),this.et=l,e.type!==r.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===l||null==e)return this.ft=void 0,this.et=e;if(e===n)return e;if("string"!=typeof e)throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.et)return this.ft;this.et=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}T.directiveName="unsafeHTML",T.resultType=1;const M=d(T),O=e`
:host {
  font-family: var(--font-family);
  font-size: var(--font-size);
  color: var(--text-1);
      ...
      ${this.readOnly?a:i`<div class="actionbar padding-small">
        ...
        <div class="cell padding-tiny">
          <form-button id="btn_pattern_new" 
            ...
            .style=${{padding:"8px 12px"}}
            @click=${()=>this._onEditEvent(g.SET_PATTERN,{key:"new"})}
          ></form-button>
          <form-button id="btn_pattern_delete" 
            icon="Times" type="${v.BORDER}"
            label="${this.msg("",{id:"pattern_delete"})}"
            .style=${{padding:"8px 12px"}}
            @click=${()=>this._onEditEvent(g.SET_PATTERN,{key:"delete"})}
          ></form-button>
        </div>
        <div class="cell mobile">
          <div class="cell padding-tiny">
            <form-select id="sel_pattern"
              ...
              .onChange=${e=>this._onEditEvent(g.CHANGE,{fieldname:"template",value:e.value})}
...
`;customElements.define("edit-view",class extends t{constructor(){super(),this.msg=e=>e,this.id=Math.random().toString(36).slice(2),this.viewName="",this.audit="",this.current={},this.template={},this.dataset={},this.pageSize=10,this.onEvent={}}static get properties(){return{id:{type:String},viewName:{type:String},audit:{type:String},current:{type:Object},template:{type:Object},dataset:{type:Object},pageSize:{type:Number},onEvent:{type:Object}}}static get styles(){return[R]}_onEditEvent(e,t){this.onEvent.onEditEvent&&this.onEvent.onEditEvent({key:e,data:t}),this.dispatchEvent(new CustomEvent("edit_event",{bubbles:!0,composed:!0,detail:{key:e,data:t}}))}render(){const{viewName:e,audit:t,template:l,dataset:n,current:o,pageSize:s}=this,r=l.view[e],d=n[r.data]||[],p=void 0===r.edited||r.edited;let m=r.actions;void 0===m&&(m={new:{action:$.NEW_EDITOR_ITEM,fkey:e},edit:{action:$.EDIT_EDITOR_ITEM,fkey:e},delete:{action:$.DELETE_EDITOR_ITEM,fkey:e}}),"all"!==t&&(m={...m,new:null,delete:null});const v=void 0!==r.edit_icon?[r.edit_icon,void 0,void 0]:["Edit",24,21.3],u=void 0!==r.delete_icon?[r.delete_icon,void 0,void 0]:["Times",19,27.6],h=void 0!==r.new_icon?r.new_icon:"Plus",b=void 0!==r.new_label?r.new_label:this.msg("",{id:"label_new"});let y={};return"table"===r.type&&(p&&(m.edit||m.delete)&&(y={...y,edit:{columnDef:{id:"edit",Header:"",headerStyle:{},Cell:({row:e})=>{const t=null!==m.edit?i`<form-icon id=${`edit_${e.id}`}
                  iconKey=${v[0]} width=${v[1]} height=${v[2]}
                  .style=${{cursor:"pointer",fill:"rgb(var(--functional-green))"}}
                  @click=${t=>{t.stopPropagation(),this._onEditEvent(g.FORM_ACTION,{params:m.edit,row:e,ref:this})}}
                ></form-icon>`:void 0,a=null!==m.delete?i`<form-icon id=${`delete_${e.id}`}
                  ...
                  @click=${t=>{t.stopPropagation(),this._onEditEvent(g.FORM_ACTION,{params:m.delete,row:e})}}
                ></form-icon>`:void 0;return i`${c(t)}${c(a)}`},cellStyle:{width:30,padding:"4px 3px 3px 8px"}}}}),y={...y,...r.fields}),i`<div id="${this.id}" class="panel" >
      ...
      <div class="row full" >
        ${"table"===r.type?i`<form-table id="view_table"
          .onAddItem=${p&&m.new?()=>this._onEditEvent(g.FORM_ACTION,{params:m.new}):void 0}
          .fields=${y} .rows=${d} ?tableFilter=${!0}
          filterPlaceholder="${this.msg("",{id:"placeholder_filter"})}"
          labelYes=${this.msg("",{id:"label_yes"})} labelNo=${this.msg("",{id:"label_no"})} 
          labelAdd=${b} addIcon=${h} 
          pageSize=${s} pagination="${f.TOP}"
        ></form-table>`:i`<form-list id="view_list"
          .rows=${d} labelAdd=${b} addIcon=${h}
          editIcon=${v[0]} deleteIcon=${u[0]} ?listFilter=${!0} 
          filterPlaceholder=${this.msg("",{id:"placeholder_filter"})}
          pageSize=${s} pagination="${f.TOP}"
          .onEdit=${p&&m.edit?e=>this._onEditEvent(g.FORM_ACTION,{params:m.edit,row:e}):void 0}
          .onDelete=${p&&m.delete?e=>this._onEditEvent(g.FORM_ACTION,{params:m.delete,row:e}):void 0}
          .onAddItem=${p&&m.new?()=>this._onEditEvent(g.FORM_ACTION,{params:m.new}):void 0}
        ></form-list>`}
      </div>
    </div>`}});const z=e`
...
`;customElements.define("edit-editor",class extends t{constructor(){super(),this.msg=e=>e,this.id=Math.random().toString(36).slice(2),this.caption="",this.audit="",this.current={},this.template={},this.dataset={},this.paginationPage=10,this.selectorPage=5,this.onEvent={}}static get properties(){return{id:{type:String},caption:{type:String},audit:{type:String},current:{type:Object},template:{type:Object},dataset:{type:Object},paginationPage:{type:Number},selectorPage:{type:Number},onEvent:{type:Object}}}static get styles(){return[z]}_onEditEvent(e,t){this.onEvent.onEditEvent&&this.onEvent.onEditEvent({key:e,data:t}),this.dispatchEvent(new CustomEvent("edit_event",{bubbles:!0,composed:!0,detail:{key:e,data:t}}))}_onNoteBlur(e){e.target._value!==e.target.value&&this.onEvent.onEditEvent({key:g.EDIT_ITEM,data:{name:"fnote",value:e.target._value}})}render(){const{caption:e,audit:t,template:l,current:n,dataset:o}=this,s=(e,t,a,l)=>i`
      <div class="row full" >
        <div class="cell" >
          <form-button id="${`btn_${e}`}" 
            icon="${a}" ?full="${!0}"
            label="${this.msg(t,{id:t})}" align=${h.LEFT}
            .style=${{"border-radius":0,"margin-top":"2px"}}
            badge="${c(l)}"
            @click=${()=>this._onEditEvent(g.CHANGE,{fieldname:"view",value:n.view===e?"":e})}
      ...
      ${n.form?i`<div class="section-container" >
          ...
          ${null!==n.item.id&&void 0!==n.item.fnote&&!0===l.options.pattern?i`${s("fnote","fnote_view","Comment")}${"fnote"===n.view?i`<edit-note id="editor_note"
                value="${n.item.fnote}" patternId="${c(n.template)}"
...
`;customElements.define("modal-formula",class extends t{constructor(){super(),this.msg=e=>e,this.formula="",this.formulaValues=[],this.partnumber="",this.description=""}static get properties(){return{formula:{type:String},formulaValues:{type:Array},partnumber:{type:String},description:{type:String}}}static get styles(){return[I]}_onModalEvent(e,t){this.onEvent&&this.onEvent.onModalEvent&&this.onEvent.onModalEvent({key:e,data:t}),this.dispatchEvent(new CustomEvent("modal_event",{bubbles:!0,composed:!0,detail:{key:e,data:t}}))}_onFormulaChange(e){this.formula=e}render(){const{formula:e,partnumber:t,formulaValues:a,description:l}=this;return i`<div class="modal">
      <div class="dialog">
        <div class="panel">
          <div class="panel-title">
            <div class="cell" >
        ...
        <div class="panel">
          ...
          <div class="section buttons" >
            <div class="section-row" >
              ...
              <div class="cell padding-small half" >
                <form-button id="btn_ok" icon="Check"
                  @click=${()=>this._onModalEvent(y.OK,{newTranstype:e,newDirection:t,refno:l,fromInventory:n&&o,nettoQty:s&&r})} 
                  type="${v.PRIMARY}" ?full="${!0}" 
                  label="${this.msg("",{id:"msg_ok"})}"
                >${this.msg("",{id:"msg_ok"})}</form-button>
              </div>
        ...
        <div class="panel">
            ...
            <div class="section-row" >
              ...
              <div class="row full">
                <div class="cell padding-small" >
                  ...
                  <form-input id="batch_no" type="${x.TEXT}"
          ...
          <div class="section buttons" >
            <div class="section-row" >
              ...
              <div class="cell padding-small half" >
                <form-button id="btn_ok" icon="Check"
                  @click=${()=>this._onModalEvent(y.OK,{batch_no:l,qty:n})} 
                  type="${v.PRIMARY}" ?full="${!0}" 
                  label="${this.msg("",{id:"msg_ok"})}"
                >${this.msg("",{id:"msg_ok"})}</form-button>
              </div>
