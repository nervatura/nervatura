...
Nervatura [gRPC](https://grpc.io/) v5 specification.
...
| values | [map RequestFunction.ValuesEntry](#requestfunctionvaluesentry) | The map of parameter values |
| value | [ bytes](#bytes) | Any json object. If it exists, the values are skip! |
